#Kelompok Irzi dan Fajar
from data import Product,Electronics,Book,Clothing,cart,product_1,product_2,product_3,product_4

print("1. ", product_1.get_name(),", Harga: ", product_1.get_price(),",Kuantiti: ", product_1.get_quantity(),",Periode: ", product_1.get_warranty_period())
print("2. ", product_2.get_name(),", Harga: ", product_2.get_price(),",Kuantiti: ", product_2.get_quantity(),",Periode: ", product_2.get_warranty_period())
print("3. ", product_3.get_name(),", Harga: ", product_3.get_price(),",Kuantiti: ", product_3.get_quantity(),",Periode: ", product_3.get_size())
print("4. ", product_4.get_name(),", Harga: ", product_4.get_price(),",Kuantiti: ", product_4.get_quantity(),",Periode: ", product_4.get_author())
...
while True:
    ...
    if pilihan == '1':
        ...
        pdt_3 ={
            ...
            'price': product_3.get_price(),
            'quantity': 1,
            'size': product_3.get_size()
        }

...
from customor import cekSaldo, tarikTunai, setorTunai, transfer, lihatTransaksi

import json

data_users = open("users.txt")
...
data_account =  open("account.txt")
account = data_account.read()
